...
@section('content')
  ...
  <div id='content-container'>
  	...
  	if($_GET && $_GET["folder"]){
  		...
  		<a onclick="showPhoto(\'\');" class="back-btn"><img src="images/photography/arrow-back.png" id="photo-album-icon"></a><span>Get back to the Directory</span></div>';
    	...
    	<p><img id="photo-album-icon"src="images/photography/cam.png">No longer take photos</p><p>Feel free to choose an album to look at!</p></div>';
